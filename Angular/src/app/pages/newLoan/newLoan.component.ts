...
export class NewLoanComponent implements OnInit{
    ...
    constructor(
        ...
        this.newLoanForm = fb.group({
            ...
            mobileNo: [{ value: "", disabled: false},[Validators.required, Validators.minLength(10)]],
    ...
    async submit(){
        var submittedValues = {
            ...
            mobileNo: JSON.stringify(this.newLoanForm.value.mobileNo),
            aMobileNo: JSON.stringify(this.newLoanForm.value.aMobileNo),
